...
class MenuAksesoris extends StatefulWidget {
  final String text;
  MenuAksesoris({Key key, @required this.text}) : super(key: key);
  @override
  _MenuAksesorisState createState() => _MenuAksesorisState();
}

class _MenuAksesorisState extends State<MenuAksesoris> {
  ...
  void getData() {
    ...
    CollectionReference users = FirebaseFirestore.instance
        .collection("Produk & Service/${widget.text}/Aksesoris");
